...
protected:
    void OnRun() override
    {
        ...
        boxEntity->AddComponent<SpriteRendererComponent>();
        boxEntity->GetComponent<SpriteComponent>()->LoadTexture("Assets/Textures/container.jpg");
        auto mesh = std::make_shared<Quad>();
        boxEntity->GetComponent<MeshFilterComponent>()->SetMesh(mesh);
        boxEntity->GetTransform().SetScale(100, 100, 1);

        boxEntity = scene->CreateEntity("box2");
        boxEntity->AddComponent<SpriteRendererComponent>();
        boxEntity->GetComponent<SpriteComponent>()->LoadTexture("Assets/Textures/container.jpg");
